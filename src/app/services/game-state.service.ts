...
//importa as constantes do jogo e estado 
...
/* 
mostra os servicos do jogo,os arrays de jogo do usuario e cpu.
...
export class GameStateService {
  ...
  /* pega do Localstorage os estados do jogo*/ 
  getAccess(): Config {
...
/**
 * Primeiro acesso ao jogo,cria variaveis no localstorage
 */
  firstStart(): void {
    let config = this.getAccess();
...
/**
 * Retorna uma cor aleatoria do jogo em uma string
 */
...
/**
 * 
 * @returns Compara os arrays do usuario e do CPU  e testa se são iguais.
 */
